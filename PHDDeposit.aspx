<%@ Page Title="" Language="C#" MasterPageFile="~/MaterialDesign.Master" AutoEventWireup="true" CodeBehind="PHDDeposit.aspx.cs" Inherits="Admissions.PHDDeposit" %>
<asp:Content ID="myHead" ContentPlaceHolderID="head" runat="server">
    <title>PHD ENrollment Deposit</title>
</asp:Content>
...
<div class="row extraSpace">
    ...
    <div class="col s12">
    <p class="noTopSpace">Please select your campus and click on the button below to pay the $100.00 enrollment fee.</p>
    </div>
...
<div class="row">
    ...
    <div class="input-field selectIcon col s12 m6 l6">
        ...
        <input type="hidden" name="description" value="PHD Online Payment" />
        <input type="hidden" name="paymentForm" value="PCAppPayments" />
        <input type="hidden" name="paymentWebsite" value="https://secure.sullivan.edu/Admissions/PHDDeposit.aspx" /> 
        <input type="hidden" name="fileName" value="SullivanPaymentRceipt" /> 
        <input type="hidden" name="docName" value="ADM - Enrollment Fee Receipt" /> 
