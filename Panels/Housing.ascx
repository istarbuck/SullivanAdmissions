<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Housing.ascx.cs" Inherits="Admissions.Panels.Housing" %>
...
<div class="row">
    ...
    <div class="input-field col s12 m6 l6">
        ...
        <asp:TextBox ID="tBoxDateOfBirth" runat="server" CssClass="datePicker" ></asp:TextBox>
...
<div class="row">
    ...
    <div class="input-field col s12 m6 l6">
        ...
        <asp:Label runat="server" Text="Apartment Number" AssociatedControlID="aptNum"></asp:Label>
    </div>
</div>
...
<div class="row ">
    ...
    <div class="input-field col s12 m6 l6">
        ...
        <asp:TextBox runat="server" ID="tbProvince"></asp:TextBox>
        <asp:Label runat="server" ID="lblProvince" AssociatedControlID="tbProvince" >Province:</asp:Label>
    </div>
...
<div class="row extraSpace">
    <div class="input-field col s12 m6 l6">
	    ...
	    <asp:TextBox runat="server" id="hschool"></asp:TextBox>
        <asp:label runat="server" ID="lblHschool" AssociatedControlID="hschool" >High School:</asp:label>
	    <asp:RequiredFieldValidator runat="server" Display="Dynamic" ErrorMessage="Required: high school" id="hschoolValidator" ControlToValidate="hschool"></asp:RequiredFieldValidator>
    </div>
   ...
   <div class="input-field selectIcon col s12 m6 l6">
    ...
    <div class="input-field selectIcon col s12 m6 l6">
        <i class="material-icons prefix">account_balance</i>       
        <asp:DropDownList runat="server" ID="campus" OnSelectedIndexChanged="campus_SelectedIndexChanged" AutoPostBack="true">
            <asp:ListItem Value="0">Please Select:</asp:ListItem>
...
<asp:Panel runat="server" ID="pnlHousingPreference">

<div class="row">

    <asp:Label runat="server" ID="lblHousing1" CssClass="miniHeader" >Housing Preference: (please note: rank 1,2 or 3 - 1 is the first choice, 2 is the second choice and 3 is the 3rd choice)</asp:Label>
    <br /><br />
...
<div class="row extraSpace">
    ...
    <div class="col s12">
        <asp:Label runat="server" ID="lblHousing2" Font-Bold="true" ForeColor="Red">Please Note: Matches will not be considered unless both students select each other.</asp:Label>
        <br /><br />
    </div>
</div>
<br />
