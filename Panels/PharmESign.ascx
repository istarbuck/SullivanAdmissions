<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PharmESign.ascx.cs" Inherits="Admissions.Panels.PharmESign" %>

<asp:Panel ID="pnlPharmESig" runat="server" CssClass="sectionGroup" GroupingText="E-Signature">
...
<%--                <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" 
    ...
    <div class="row">
        ...
        <asp:UpdatePanel runat="server" ID="updESig3" UpdateMode="Conditional">
        <ContentTemplate>
