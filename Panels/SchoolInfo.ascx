<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SchoolInfo.ascx.cs" Inherits="Admissions.Panels.SchoolInfo" %>
...
<div class="row extraSpace">
   ...
   <div class="input-field col s12 m6 l6"> 
        ...
        <asp:Label ID="Label1" runat="server" AssociatedControlID="tbGPA" CssClass="optional">High School GPA</asp:Label>
    </div>
...
<asp:Panel runat="server" ID="Panel1" CssClass="sectionGroup" GroupingText="Unofficial Transcripts">
    ...
    <div class="row extraSpace">
        ...
        <div class="col s6">
            <asp:Label runat="server"><b>Upload your unofficial transcripts (Optional).</b></asp:Label>
