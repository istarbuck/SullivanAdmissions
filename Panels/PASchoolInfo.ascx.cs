...
{
    public partial class PASchoolInfo : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                pnlOfferAcceptance.Visible = false;
                pnlMedNonGraduate.Visible = false;
                pnlMedGraduate.Visible = false;
        ...
        protected void rblMedAcceptance_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (rblMedAcceptance.SelectedItem.Text == "Yes")
                pnlOfferAcceptance.Visible = true;
            else
                pnlOfferAcceptance.Visible = false;
        }

        protected void rblOfferGraduate_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (rblOfferGraduate.SelectedItem.Text == "Yes")
            {
                pnlMedGraduate.Visible = true;
                pnlMedNonGraduate.Visible = false;
            }
            else
            {
                pnlMedGraduate.Visible = false;
                pnlMedNonGraduate.Visible = true;
            }
        }
    }
}