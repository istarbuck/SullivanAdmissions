...
<script runat="server">
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    ...
    if (ex.InnerException.Message.StartsWith("Handled: "))
        safeMsg = ex.InnerException.Message.Replace("Handled: ","");
      
    //Application title
    Page.Title = ConfigurationManager.AppSettings["AppName"] + " Error Page";
    lblApplication2.Text = ConfigurationManager.AppSettings["AppName"];
    ...
    // Log the exception and notify system operators (already sent in global.asax)
    //ExceptionUtility.LogException(ex, "Generic Error Page", Session);
    //ExceptionUtility.NotifySystemOps(ex, "Generic Error Page", Session);
...
<body>
  ...
  <div>
    <h2>
      <asp:Label ID="lblApplication2" runat="server" /> Error Page</h2>
