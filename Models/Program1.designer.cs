...
namespace Admissions.Models
{
	...
	public partial class CompFee
	{
		...
		private System.Nullable<int> _timesCharged;
		
		private string _feesCharged;
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_timesCharged", DbType="Int")]
		public System.Nullable<int> timesCharged
		{
			get
			{
				return this._timesCharged;
			}
			set
			{
				if ((this._timesCharged != value))
				{
					this._timesCharged = value;
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_feesCharged", DbType="VarChar(25)")]
		public string feesCharged
		{
			get
			{
				return this._feesCharged;
			}
			set
			{
				if ((this._feesCharged != value))
				{
					this._feesCharged = value;
				}
			}
		}
	}
	...
	public partial class Program : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<decimal> _BookFees;
    ...
    partial void OnBookFeesChanging(System.Nullable<decimal> value);
    partial void OnBookFeesChanged();
    ...
    partial void OnNorthernKentuckyChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_BookFees", DbType="Decimal(6,2)")]
		public System.Nullable<decimal> BookFees
		{
			get
			{
				return this._BookFees;
			}
			set
			{
				if ((this._BookFees != value))
				{
					this.OnBookFeesChanging(value);
					this.SendPropertyChanging();
					this._BookFees = value;
					this.SendPropertyChanged("BookFees");
					this.OnBookFeesChanged();
				}
			}
		}
