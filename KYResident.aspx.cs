...
{
    public partial class KYResident : System.Web.UI.Page
    {
        ...
        protected void Submit_Click(object sender, EventArgs e)
        {
            ...
            email.SendHTMLEmail("KY Resident - " + PersonalInfoForm.StudentName, emailBody, To, Bcc, Cc, "DoNotReply@sullivan.edu", attachments);
        ...
        private void Tiffer()
        {
            ...
            try
            {
                ...
                email.SendEmail("KY Resident", tiffEmailBody + "doctype=ADM - KY Residency Determination", attachments, emailTo);
                attachments.Clear();
