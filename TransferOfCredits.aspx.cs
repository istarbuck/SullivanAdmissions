...
{
    public partial class TransferOfCredits : System.Web.UI.Page
    {
        ...
        protected void Submit_Click(object sender, EventArgs e)
        {
            ...
            email.SendHTMLEmail("Transfer Of Credits - " + PersonalInfoForm.StudentName, emailBody, To, Bcc, Cc, "DoNotReply@sullivan.edu", attachments);
