<%@ Page Title="" Language="C#" MasterPageFile="~/MaterialDesign.Master" AutoEventWireup="true" CodeBehind="PayFees.aspx.cs" Inherits="Admissions.PayFees" %>
...
<div class="row">
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="campus" ErrorMessage="Required: Campus" SetFocusOnError="true" InitialValue="0" 
     ...
     <div class="input-field topSpace col s12 m6 l6"> 
        ...
        <div class="radio">
        <asp:RadioButtonList ID="military" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" onselectedindexchanged="FeeDisplay" >
